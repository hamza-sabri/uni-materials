...
export default function ViewAllRes({ match }: { match: infoPageMatch<{ matID: string }> }) {
    ...
    function RatingHtmlComp({submitRating}: any) {
        ...
        let comment = "very bad";
        let setComment = (val: string) => {comment = val};

        return (
            <div className="popup-rate-container">
                <div className="rate">
                    <input type="radio" id="star5" name="rate" value="5" onClick={(e) => {setComment("very good"); setVal(Number(e.currentTarget.value))}} />
                    <label htmlFor="star5" title="text">5 stars</label>
                    <input type="radio" id="star4" name="rate" value="4" onClick={(e) => {setComment("good"); setVal(Number(e.currentTarget.value))}} />
                    <label htmlFor="star4" title="text">4 stars</label>
                    <input type="radio" id="star3" name="rate" value="3" onClick={(e) => {setComment("mediocre"); setVal(Number(e.currentTarget.value))}} />
                    <label htmlFor="star3" title="text">3 stars</label>
                    <input type="radio" id="star2" name="rate" value="2" onClick={(e) => {setComment("bad"); setVal(Number(e.currentTarget.value))}} />
                    <label htmlFor="star2" title="text">2 stars</label>
                    <input type="radio" id="star1" name="rate" value="1" onClick={(e) => {setComment("very bad"); setVal(Number(e.currentTarget.value))}} checked />
                ...
                <button className="confirm-btn" type="submit" onClick={() => {if(commentRef.current){ submitRating(rateVal, commentRef.current.value || comment)}}}>Submit Rating</button>
            </div >
        )
    }
